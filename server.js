...
router.route('/addfield').post((request, response) => {
    ...
    dboperations.addField(field).then(result => {
...
router.route('/addfaction').post((request, response) => {
    ...
    dboperations.addFaction(faction).then(result => {
        response.status(201).json(result);
    }).catch(err => {
        console.error(err);
        response.sendStatus(500);
...
router.route('/adddepartment').post((request, response) => {
    ...
    dboperations.addDepartment(department).then(result => {
        response.status(201).json(result);
    }).catch(err => {
        console.error(err);
        response.sendStatus(500);
...
router.route('/addposition').post((request, response) => {
    ...
    dboperations.addPosition(position).then(result => {
        response.status(201).json(result);
    }).catch(err => {
        console.error(err);
        response.sendStatus(500);
...
router.route('/updatefield').post((request, response) => {
    ...
    dboperations.updateField(field).then(result => {
...
router.route('/updatefaction').post((request, response) => {
    ...
    dboperations.updateFaction(faction).then(result => {
        response.status(200).json(result);
    }).catch(err => {
        console.error(err);
        response.sendStatus(500);
...
router.route('/updatedepartment').post((request, response) => {
    ...
    dboperations.updateDepartment(department).then(result => {
        response.status(200).json(result);
    }).catch(err => {
        console.error(err);
        response.sendStatus(500);
...
router.route('/updateposition').post((request, response) => {
    ...
    dboperations.updatePosition(position).then(result => {
        response.status(200).json(result);
    }).catch(err => {
        console.error(err);
        response.sendStatus(500);
...
router.route('/setfieldactivate').post((request, response) => {
    ...
    dboperations.setFieldActivate(field).then(result => {
        response.status(200).json(result);
    }).catch(err => {
        console.error(err);
        response.sendStatus(500);
...
router.route('/setfactionactivate').post((request, response) => {
    ...
    dboperations.setFactionActivate(faction).then(result => {
        response.status(200).json(result);
    }).catch(err => {
        console.error(err);
        response.sendStatus(500);
...
router.route('/setdepartmentactivate').post((request, response) => {
    ...
    dboperations.setDepartmentActivate(department).then(result => {
        response.status(200).json(result);
    }).catch(err => {
        console.error(err);
        response.sendStatus(500);
...
router.route('/setpositionactivate').post((request, response) => {
    ...
    dboperations.setPositionActivate(position).then(result => {
        response.status(200).json(result);
    }).catch(err => {
        console.error(err);
        response.sendStatus(500);
...
router.route('/deletefield/:field_id').delete((request, response) => {
    ...
    dboperations.deleteField(request.params.field_id).then(result => {
        response.status(200).json(result);
    }).catch(err => {
        console.error(err);
        response.sendStatus(500);
...
router.route('/deletefaction/:faction_id').delete((request, response) => {
    ...
    dboperations.deleteFaction(request.params.faction_id).then(result => {
        response.status(200).json(result);
    }).catch(err => {
        console.error(err);
        response.sendStatus(500);
...
router.route('/deletedepartment/:department_id').delete((request, response) => {
    ...
    dboperations.deleteDepartment(request.params.department_id).then(result => {
        response.status(200).json(result);
    }).catch(err => {
        console.error(err);
        response.sendStatus(500);
...
router.route('/deleteposition/:position_id').delete((request, response) => {
    ...
    dboperations.deletePosition(request.params.position_id).then(result => {
        response.status(200).json(result);
    }).catch(err => {
        console.error(err);
        response.sendStatus(500);
